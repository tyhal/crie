...
type Language struct {
	...
	Fmt       Linter `json:"fmt" yaml:"fmt,omitempty" jsonschema_description:"used for the given language when formatting"`
	Chk       Linter `json:"chk" yaml:"chk,omitempty" jsonschema_description:"used for the given language when linting/checking"`
}
